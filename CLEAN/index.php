  ...
  <div class="container">
    <div class="section">
      ...
      <div class="row">
        ...
        <div class="col s12 m6">
        <br>
        <h5 class="left">Potential Workers:</h5>
        <br><br><br>
    <ul class="collection" id="freelance">
      ...
      <img class="material-icons circle green" src="img/3.jpg">
       ...
       <form class="login_form" method="post" action="">
        ...
        <input type="hidden" name="username" value="Kevin Barasa"/>
      ...
      <img class="material-icons circle green" src="img/5.jpg">
       ...
       <form class="login_form" method="post" action="">
        ...
        <input type="hidden" name="username" value="John Mark"/>
        <input type="hidden" name="password" value="qwerty"/>
      ...
      <img class="material-icons circle green" src="img/4.jpg">
       ...
       <form class="login_form" method="post" action="">
        ...
        <input type="hidden" name="username" value="Boniface Kibicho"/>
        <input type="hidden" name="password" value="qwerty"/>
